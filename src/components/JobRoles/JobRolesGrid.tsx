...
import { Plus, Brain, ChevronDown, MoreVertical, Star, Calendar, FileText, Users, ChevronRight } from "lucide-react";
import { PieChart as RechartsPieChart, Pie as RechartsPie, Cell as RechartsCell, ResponsiveContainer as RechartsResponsiveContainer, Tooltip as RechartsTooltip } from "recharts";
import { jobs, pipeline, sources, activity, quickActions, alerts, funnel } from "./data";
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
          ...
          <div className="flex items-center gap-4">
            <div className="relative flex-shrink-0" style={{width:130,height:130}}>
              <RechartsResponsiveContainer width={130} height={130}>
                <RechartsPieChart>
                  <RechartsPie data={sources} cx="50%" cy="50%" innerRadius={38} outerRadius={58} startAngle={90} endAngle={-270} dataKey="value" strokeWidth={2} stroke="#fff">
                    {sources.map((e,i)=><RechartsCell key={i} fill={e.color}/>)}
                  </RechartsPie>
                  <RechartsTooltip contentStyle={{fontSize:11,borderRadius:8}} formatter={(v:any,n:any)=>[v,n]}/>
                </RechartsPieChart>
